  ...
  return (
    <footer className='bg-[#111]'>
      <div className='mx-auto max-w-[1440px]'>
        <div className='mb-4 flex pt-10'>
          <div className='w-3/4 text-neutral-400 flex'>
            <div className='w-1/4 px-[6px]'>
              <ul className='flex flex-col space-y-2'>
                {leftSideLinks.map((link, idx) => {
                  return (
                    <li key={`${link.title}${idx}`} className='mb-1'>
                      <Link href={link.url} className='text-white text-sm'>
                        {link.title}
                      </Link>
                    </li>
                  );
                ...
                {middleLinks.map((link, idx) => {
                  return (
                    <li key={`${link.title}${idx}`} className='mb-1'>
                      <Link
                        href={link.url}
                        className='text-[#7e7e7e] hover:text-white text-xs'
                      >
                        {link.title}
                      </Link>
                    </li>
          ...
          <div className='flex space-x-4 justify-end w-1/4'>
            {socialLinks.map((link) => {
              return (
                <Link href={link.url}>
                  <svg
                    className='fill-[#7e7e7e] hover:fill-white transition-color duration-200'
                    width='30px'
                    fill='#111'
                    height='30px'
                    viewBox='0 0 24 24'
