  ...
  return (
    <div className='w-full'>
      <div className='h-9 bg-neutral-100 relative w-full z-20'>
        <div className='px-9 max-w-[1920] max-h-[60] opacity-100 h-full mx-auto flex justify-between flex-nowrap flex-row'>
          <ul className='flex'>
            <li className='flex w-full h-full items-center'>
              <Link
                href={'https://www.nike.com/jordan'}
                className='flex w-full h-full items-center bg-transparent px-3'
              >
          ...
          <div className='flex flex-row space-x-2 text-[#111]'>
            <div className='flex items-center text-xs font-medium space-x-2 pr-[2]'>
              <Link href={'/retail'}>
